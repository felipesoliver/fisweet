    ...
    <section className='main-hero bg-blue-light lg:h-[44rem] overflow-hidden'>
      <Grid className='container h-full gap-y-5 lg:gap-y-0'>
        <div className='col-span-full lg:col-span-6 flex flex-col justify-center pt-5 lg:pt-0'>
          <h1 className='text-4xl lg:heading-7xl mb-3'><Flip left cascade>Prosper with our bespoke solutions</Flip></h1>
          ...
          <p className='hidden lg:block text-gray-medium opacity-50 mt-16 mb-4'>Worked with 100+ Companies</p>
          <div className='hidden lg:flex items-center justify-between max-w-[31.875rem] h-8'>
