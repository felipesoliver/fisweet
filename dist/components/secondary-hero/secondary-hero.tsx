  ...
  return (
    <section className='py-10 lg:py-20'>
      <div className='container flex flex-col-reverse lg:grid lg:grid-cols-12 gap-5'>
        ...
        <Fade>
          <div className='relative w-full lg:col-span-6 after:rounded-l-[1.25rem] after:absolute after:top-0 after:left-0 after:w-[5rem] after:lg:w-[11.25rem] after:h-full after:bg-orange after:bg-opacity-80'>
